...
public class SummonerController {
    ...
    public String searchSummonerData(@RequestParam("summonerName") String summonerName, Model model,
        ...
        model.addAttribute("target", summoner_register);
        return "redirectPost";
    }

    @PostMapping("/updateSummonerName.do")
    public String updateSummonerData(Model model, HttpServletRequest request) throws UnsupportedEncodingException {
        ...
        if (memberDTO.getTeamName() != null){
            model.addAttribute("target", "updateSummonerName");
            model.addAttribute("teamExist", "teamExist");
            return "redirectPost";
    ...
    @PostMapping("/updateSummonerData.do")
