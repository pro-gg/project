        ...
        function solo_rank_nickname(){
            ...
            if(tier !== ''){
                document.getElementById("rankedSoloNickname").innerHTML="<dt><b>솔로 랭크</b></dt>" +
                	"<dd><img src='/resources/images/Emblem_${ranked_solo.tier}.png' style='width:100px; height:100px;'/></dd>" +
            	...
            	document.getElementById("rankedSoloNickname").innerHTML="<dt><b>솔로 랭크</b></dt>" +
        		"<dd><img src='/resources/images/provisional.png' style='width:100px; height:100px;'/></dd>" +
        		"<dd>Unranked</dd>";
        	}
        }
        ...
        function flex_rank_nickname(){
            ...
            if(tier !== ''){
                document.getElementById("rankedFlexNickname").innerHTML="<dt><b>자유 랭크</b></dt>" +
                	"<dd><img src='/resources/images/Emblem_${ranked_flex.tier}.png' style='width:100px; height:100px;'/></dd>" +
